...
import { ArrowRight, CheckCircle2, Plus, Building2 } from "lucide-react";
import { motion } from "framer-motion";

export default function ServicesPage({ initialServices = [] }: { initialServices?: any[] }) {
  const servicesList = initialServices.length > 0 ? initialServices : Object.values(servicesData);
  return (
    <main className="min-h-screen bg-transparent relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="pt-32 pb-16 md:pt-40 md:pb-24 px-6 relative overflow-hidden">
          <div className="container mx-auto max-w-4xl text-center relative z-20">
            ...
            <div className="mb-6 flex justify-center">
              <Breadcrumbs items={[
                { name: "Services", item: "https://trekgroups.com/services" }
              ]} />
            </div>
          ...
          <div className="container mx-auto max-w-7xl relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {servicesList.map((service, index) => {
                const ServiceIcon = (typeof service.icon === "string" || !service.icon) ? Building2 : service.icon;
                return (
                  <motion.div
                    key={service.id}
                  ...
                  >
                    ...
                    <Link href={`/services/${service.slug || service.id}`} className="inline-flex items-center gap-2 text-secondary font-black text-sm group-hover:text-white transition-colors">
                      Learn More
        ...
        {/* Add Service Button under the page */}
        <div className="pb-16 text-center relative z-20">
          <Link
            href="/blog/admin"
