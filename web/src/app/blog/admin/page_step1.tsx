...
export default function AdminPage() {
  ...
  const [blogCanonical, setBlogCanonical] = useState("");
  const [blogImageAlt, setBlogImageAlt] = useState("");
  const [blogOgImage, setBlogOgImage] = useState("");
  const [blogPublishedDate, setBlogPublishedDate] = useState("");
  const [blogUpdatedDate, setBlogUpdatedDate] = useState("");
  ...
  const [activeServiceTab, setActiveServiceTab] = useState<"list" | "edit">("list");
