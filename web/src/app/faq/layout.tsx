...
export const metadata: Metadata = {
  ...
  description: "Get answers to your questions about company formation, CR registration, 100% foreign ownership, PRO clearances, and corporate services in Doha.",
  keywords: ["Qatar Business FAQ", "Company Registration Doha help", "LLC Setup questions Qatar", "PRO services Doha help"],
};
