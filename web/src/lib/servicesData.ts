...
export const servicesData: Record<string, ServiceData> = {
  "company-formation-business-setup": {
    ...
    description:
      "Establish your business in Qatar successfully. We handle your Commercial Registration (CR), licensing, and legal structuring.",
    icon: Building2,
    color: "bg-indigo-500",
    lightColor: "bg-indigo-500/10",
    textColor: "text-indigo-500",
    metaTitle:
      "Business Setup in Qatar | Company Formation & Company Registration | Trek Group Qatar",
    metaDescription:
      "Establish your business in Qatar successfully with Trek Group. End-to-end solutions for LLC formation, QFC registration, Free Zone setup, and MOCI licensing.",
    keywords: [
      "100% Foreign Ownership Qatar",
      "100% Foreign Ownership Company Qatar",
      "Foreign Company Registration Qatar",
      "Foreign Investment Qatar",
      ...
      "Foreign Investor Business Qatar",
      "Business Licensing Qatar",
    ...
    schemaMarkup: {
      ...
      areaServed: "QA",
      description:
        "End-to-end solutions for LLC formation, QFC registration, Free Zone setup, and MOCI licensing in Qatar.",
    },
    sections: [
      {
  ...
  "one-hundred-percent-foreign-ownership": {
    ...
    description:
      "Retain 100% ownership and operational control of your business in Qatar under the latest MOCI foreign investment framework.",
    icon: ShieldCheck,
    color: "bg-blue-600",
    lightColor: "bg-blue-600/10",
    textColor: "text-blue-600",
    metaTitle:
      "100% Foreign Ownership in Qatar | Foreign Company Registration | Trek Group Qatar",
    metaDescription:
      "Establish your company with 100% foreign ownership in Qatar. Learn about eligible sectors, MOCI approvals, Single Window registration, and regulatory pathways.",
    keywords: [
      "100% Foreign Ownership Qatar",
      "100% Foreign Ownership Company Qatar",
      "Foreign Company Registration Qatar",
      ...
      "Qatar LLC Registration",
      "Foreign Investor Business Qatar",
      "100% Foreign Owned Company Qatar",
      "Foreign Ownership Business Setup Qatar",
      "Business License Qatar",
      "Corporate Services Qatar",
      "Business Expansion Qatar",
      "Company Incorporation Qatar",
      "Doha Business Setup",
      "Entrepreneur Services Qatar",
      "Company Incorporation Doha",
      "Business Registration Doha",
      "Trek Group Qatar",
    ],
    schemaMarkup: {
      "@context": "https://schema.org",
      ...
      areaServed: "QA",
      description:
        "Guiding international investors through 100% foreign ownership registration and MOCI regulations in Doha, Qatar.",
    },
    sections: [
      {
  ...
  "qatari-sponsor-services": {
    ...
    description:
      "Trusted local partnership and Qatari sponsor arrangements structured to legally protect your investments.",
    icon: UserCheck,
    color: "bg-purple-500",
    ...
    metaDescription:
      "Find a reliable Qatari sponsor or local partner with Trek Group. Professional agreements protecting your business operations and capital in Qatar.",
    keywords: [
      "Qatari Sponsor Services",
      "Local Sponsor Qatar",
      "Qatari Local Partner",
      "Qatari Sponsor Company",
      "Business Sponsor Qatar",
      "Local Sponsor for Business Qatar",
      "Business Setup in Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
      "Register a Company in Qatar",
      ...
      "Trade License Qatar",
      "Corporate Services Qatar",
      "Local Shareholder Qatar",
      "Qatari Shareholder Services",
      "Sponsorship Agreement Qatar",
      "Shareholder Agreement Qatar",
      "Legal Documentation Qatar",
      "Government Approvals Qatar",
      "Business Licensing Qatar",
      "Foreign Company Registration Qatar",
      "Mainland Company Formation Qatar",
      "Business Expansion Qatar",
  ...
  "share-transfer-cr-amendments": {
    ...
    description:
      "Manage company ownership modifications, shareholder changes, and Commercial Registration updates smoothly.",
    icon: FileText,
    color: "bg-rose-500",
    ...
    metaDescription:
      "Professional support for share transfers, partner additions or removals, company name changes, and Commercial Registration (CR) amendments in Qatar.",
    keywords: [
      "Share Transfer Qatar",
      "Share Transfer Services Qatar",
      "Company Share Transfer Qatar",
      "CR Amendments Qatar",
      "Commercial Registration Amendments Qatar",
      "Company Registration Amendments Qatar",
      "Company Restructuring Qatar",
      "Business Ownership Transfer Qatar",
      "Add Shareholder Qatar",
      "Remove Shareholder Qatar",
      "Shareholder Changes Qatar",
      "Company Name Change Qatar",
      "Business Activity Amendment Qatar",
      "Capital Amendment Qatar",
      "Articles of Association Amendment Qatar",
      "AOA Amendment Qatar",
      "Trade License Amendments Qatar",
      "Company Legal Documentation Qatar",
      "Ministry of Justice Qatar",
      "Sale Deed Assistance Qatar",
      "Corporate Services Qatar",
      "Business Consultancy Qatar",
      "Business Setup in Qatar",
      "Company Formation Qatar",
    ...
    sections: [
      {
        title:
          "Professional Share Transfer & Company Amendment Services in Qatar",
  ...
  "pro-services": {
    ...
    id: "pro-services",
    description:
      "Corporate government clearing, visa processing, document clearance, and automated compliance tracking.",
    icon: Award,
    color: "bg-emerald-500",
    lightColor: "bg-emerald-500/10",
    textColor: "text-emerald-500",
    metaTitle:
      "PRO Services Qatar | Corporate PRO Outsourcing & Government Liaison",
    metaDescription:
      "Save operational costs with Trek Group's Corporate PRO services. Monthly PRO outsourcing, ministry approvals, labor registrations, and ERP reminder systems.",
    keywords: [
      "PRO Services Qatar",
      "Corporate PRO Services Qatar",
      "PRO Outsourcing Qatar",
      "Business PRO Services Qatar",
      "Government Liaison Qatar",
      "Document Clearance Qatar",
      "Company PRO Services Doha",
      "Visa Processing Qatar",
      "QID Processing Qatar",
      "Labour Card Services Qatar",
      "Immigration Services Qatar",
      "Trade License Renewal Qatar",
      "Commercial Registration Renewal Qatar",
      "CR Renewal Qatar",
      "Document Attestation Qatar",
      "Government Approvals Qatar",
      "Ministry Approvals Qatar",
      "Business Compliance Qatar",
      "Corporate Compliance Qatar",
      "Business Documentation Qatar",
      "ERP Document Management Qatar",
      "Document Reminder System Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
      "Business Setup in Qatar",
      "Register a Company in Qatar",
    ...
    sections: [
      {
        title:
          "Professional Corporate PRO Services for Complete Business Support in Qatar",
  ...
  "legal-translation": {
    ...
    description:
      "Certified legal and corporate translations recognized by government ministries in Qatar.",
    icon: Globe2,
    color: "bg-cyan-500",
    lightColor: "bg-cyan-500/10",
    textColor: "text-cyan-500",
    metaTitle:
      "Legal Translation Qatar | Certified Document Translation Services",
    metaDescription:
      "Get fast and accurate certified legal translation in Doha. Arabic, English, French, Hindi, and Urdu translation for ministries, courts, and visas.",
    keywords: [
      "Legal Translation Qatar",
      "Certified Translation Qatar",
      "Legal Translation Doha",
      "Certified Translation Doha",
      "Arabic Translation Qatar",
      "English to Arabic Translation Qatar",
      "Arabic to English Translation Qatar",
      "Business Document Translation Qatar",
      "Commercial Document Translation Qatar",
      "Corporate Translation Qatar",
      "Visa Document Translation Qatar",
      "Immigration Document Translation Qatar",
      "Court Document Translation Qatar",
      "Educational Certificate Translation Qatar",
      "Medical Document Translation Qatar",
      "Ministry Approved Translation Qatar",
      "Official Translation Services Qatar",
      "Professional Translation Services Qatar",
      "Translation Services Doha",
  ...
  "certificate-attestation": {
    ...
    description:
      "Complete authentication and attestation of educational, personal, and commercial documents from MOFA.",
    icon: FileCheck,
    color: "bg-amber-500",
    lightColor: "bg-amber-500/10",
    textColor: "text-amber-500",
    metaTitle:
      "Certificate Attestation Qatar | MOFA, Embassy & Degree Attestation",
    metaDescription:
      "Fast educational, marriage, and commercial certificate attestation in Qatar. Complete MOFA, Embassy, and foreign ministry legalization support.",
    keywords: [
      "Certificate Attestation Qatar",
      "Certificate Attestation Doha",
      "Document Attestation Qatar",
      "Document Attestation Doha",
      "MOFA Attestation Qatar",
      "MOFA Attestation Doha",
      "Embassy Attestation Qatar",
      "Degree Certificate Attestation Qatar",
      "Educational Certificate Attestation Qatar",
      "Marriage Certificate Attestation Qatar",
      "Birth Certificate Attestation Qatar",
      "Experience Certificate Attestation Qatar",
      "Medical Certificate Attestation Qatar",
      "Commercial Document Attestation Qatar",
      "Business Document Attestation Qatar",
      "Qatar Certificate Authentication",
      "Foreign Document Attestation Qatar",
      "Visa Document Attestation Qatar",
      "Legalization Services Qatar",
      "Business Setup Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
      "Corporate Services Qatar",
  ...
  "visa-services": {
    ...
    id: "visa-services",
    description:
      "Qatar family visit, residence, and work visas along with international Schengen, UK, and US visa application support.",
    icon: Plane,
    ...
    metaDescription:
      "Immigration and visa services in Qatar. Assistance with family visit, residence, work visas, QID processing, and international visa applications.",
    keywords: [
      "Visa Services Qatar",
      "Visa Services Doha",
      "Immigration Services Qatar",
      "Immigration Support Doha",
      "Work Visa Qatar",
      ...
      "Hayya Visa Qatar",
      "QID Processing Qatar",
      "Qatar Visa Consultants",
      "Visa Documentation Qatar",
      "Visa Application Qatar",
      "Schengen Visa Assistance Qatar",
      "USA Visa Assistance Qatar",
      "Canada Visa Assistance Qatar",
      "UK Visa Assistance Qatar",
      "France Visa Assistance Qatar",
      "Business Setup Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
      "Corporate Services Qatar",
  ...
  "corporate-bank-account-assistance": {
    ...
    description:
      "Guidance on opening business bank accounts, salary coordination, WPS, and POS merchant solutions.",
    icon: Landmark,
    color: "bg-purple-600",
    ...
    metaDescription:
      "Open a corporate bank account in Qatar easily. Trek Group helps prepare financial profiles, coordinates bank applications, WPS payroll, and POS systems.",
    keywords: [
      "Corporate Bank Account Qatar",
      "Corporate Bank Account Opening Qatar",
      "Business Bank Account Qatar",
      "Open Business Bank Account Qatar",
      "Open Corporate Bank Account Doha",
      "Business Banking Qatar",
      "Corporate Banking Qatar",
      "SME Bank Account Qatar",
      "Startup Bank Account Qatar",
      "Company Bank Account Qatar",
      "Corporate Banking Assistance Qatar",
      "Business Banking Support Qatar",
      "Qatar National Bank Business Account",
      "Commercial Bank Qatar Business Account",
      "Qatar Islamic Bank Business Account",
      "Qatar International Islamic Bank Business Account",
      "Doha Bank Business Account",
      "Wage Protection System Qatar",
      "WPS Payroll Qatar",
      "Corporate Payroll Qatar",
      "POS Merchant Services Qatar",
      "Business Telecom Services Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
      "Business Setup in Qatar",
      "Business Setup Consultants Qatar",
  ...
  "tax-documentation-support": {
    ...
    description:
      "Audit preparation support, financial document organization, and licensed auditor coordination.",
    icon: Calculator,
    color: "bg-amber-600",
    ...
    metaDescription:
      "Prepare for audit compliance in Qatar. Organize financial records, audit documentation, and connect with licensed audit professionals in Doha.",
    keywords: [
      "Tax Documentation Qatar",
      "Tax Documentation Support Qatar",
      "Audit Documentation Qatar",
      "Audit Support Qatar",
      "Audit Support Doha",
      "Audit Coordination Qatar",
      "Licensed Auditor Qatar",
      "Accounting Services Qatar",
      "Accounting Support Qatar",
      "Bookkeeping Services Qatar",
      "Bookkeeping Compliance Qatar",
      "Financial Documentation Qatar",
      "Financial Record Management Qatar",
      "Corporate Tax Documentation Qatar",
      "Business Financial Records Qatar",
      "Company Audit Preparation Qatar",
      "Annual Audit Qatar",
      "Business Compliance Qatar",
      "Corporate Compliance Qatar",
      "Financial Compliance Qatar",
      "Business Consultancy Qatar",
      "Corporate Services Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
  ...
  "software-services": {
    ...
    description:
      "Custom software development, website design, ERP implementation, and digital growth systems.",
    icon: Code2,
    color: "bg-cyan-500",
    lightColor: "bg-cyan-500/10",
    textColor: "text-cyan-500",
    ...
    metaDescription:
      "Grow your business online. Custom software development, mobile apps, ERP implementation, digital marketing, and web design in Doha.",
    keywords: [
      "Software Services Qatar",
      "Software Development Qatar",
      "Software Company Qatar",
      "IT Services Qatar",
      "Technology Solutions Qatar",
      "Web Development Qatar",
      "Website Development Qatar",
      "Web Development Doha",
      "Custom Website Development Qatar",
      "Mobile App Development Qatar",
      "Android App Development Qatar",
      "iOS App Development Qatar",
      "React Development Qatar",
      "Next.js Development Qatar",
      "React Native Development Qatar",
      "Flutter Development Qatar",
      "Node.js Development Qatar",
      ...
      "CRM Solutions Qatar",
      "Salesforce Consulting Qatar",
      "HubSpot CRM Qatar",
      "AI Solutions Qatar",
      "AI Chatbot Development Qatar",
      "Business Automation Qatar",
      "Robotic Process Automation Qatar",
      "Document Automation Qatar",
      "Digital Transformation Qatar",
      "Cloud Solutions Qatar",
      "AWS Services Qatar",
      "Microsoft Azure Qatar",
      "Google Cloud Qatar",
      "Cyber Security Qatar",
      "IT Infrastructure Qatar",
      "VPN Solutions Qatar",
      "Google Workspace Qatar",
      "Microsoft 365 Qatar",
    ...
    sections: [
      {
        title:
          "Empower Your Qatar Business with Advanced Software & Digital Systems",
  ...
  "additional-business-services": {
    ...
    description:
      "Office setup coordination, interior fit-outs, typing, and company cancellation/closure procedures.",
    icon: ArrowRight,
    color: "bg-secondary",
    ...
    metaDescription:
      "Comprehensive administrative solutions in Doha. Office setup coordination, interior fit-outs, professional typing, and company closure services.",
    keywords: [
      "Additional Business Services Qatar",
      "Business Support Services Qatar",
      "Business Support Qatar",
      "Business Consultancy Qatar",
      "Corporate Consultancy Qatar",
      "Business Documentation Qatar",
      "Company Documentation Qatar",
      "Document Processing Qatar",
      "Typing Services Qatar",
      "Professional Typing Services Doha",
      "Office Setup Qatar",
      "Office Fit Out Qatar",
      "Office Fit-outs Doha",
      "Office Interior Design Qatar",
      "Business Branding Qatar",
      "Company Profile Design Qatar",
      "Corporate Branding Qatar",
      "Trade License Amendments Qatar",
      "Commercial Registration Amendments Qatar",
      "Company Closure Qatar",
      "Company Closure Doha",
      "Business Liquidation Qatar",
      "Company Cancellation Qatar",
      "Power of Attorney Qatar",
      "POA Documentation Qatar",
      "Contract Preparation Qatar",
      "Business Expansion Qatar",
      "Entrepreneur Services Qatar",
      "Startup Consulting Qatar",
      "SME Business Services Qatar",
      "Corporate Services Qatar",
      "Business Setup in Qatar",
      "Company Formation Qatar",
      "Company Registration Qatar",
